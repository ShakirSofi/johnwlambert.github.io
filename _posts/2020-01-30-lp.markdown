...
<div class="fig figcenter fighighlight">
  <img src="/assets/convex_cone_example.png" width="90%">
  <div class="figcaption">
    Convex cone, anchored around the origin (0,0) and withh edges passing throughh two other points -- (1,0) and (1,1).
  </div>
</div>
